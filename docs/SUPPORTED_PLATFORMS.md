...
| macOS | Apple Silicon and x86-64 CLI; explicitly acknowledged Node permission mode | Agent/auto execution denies when native containment is unavailable unless policy passes `--allow-degraded-sandbox` |
